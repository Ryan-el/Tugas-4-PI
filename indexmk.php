...
<a href="createmk.php">Tambah Data</a>
<br>
<a href="printmk.php" target="_blank">Cetak Data</a>
<br><br>
<table border="1">
<thead>
<tr>
...
<td>
<a name="edit" id="edit"
href="editmk.php?nim=<?=$data->nim ?>">Edit</a>
<a name="hapus" id="hapus"
href="prosesmk.php?nim=<?=$data->nim ?>">Delete</a>
</td>
</tr>
<?php endforeach;
} else{ ?>
